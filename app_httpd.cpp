...
static esp_err_t index_handler(httpd_req_t *req){
    ...
    page += "var fullscreenBtn = document.getElementById('fullscreenBtn');";
    page += "function toggleFullscreen() {";
    page += "    if (!document.fullscreenElement && !document.webkitFullscreenElement && !document.msFullscreenElement) {";
    page += "        if (document.documentElement.requestFullscreen) { document.documentElement.requestFullscreen(); }";
    page += "        else if (document.documentElement.webkitRequestFullscreen) { document.documentElement.webkitRequestFullscreen(); }";
    page += "        else if (document.documentElement.msRequestFullscreen) { document.documentElement.msRequestFullscreen(); }";
    page += "    } else {";
    page += "        if (document.exitFullscreen) { document.exitFullscreen(); }";
    page += "        else if (document.webkitExitFullscreen) { document.webkitExitFullscreen(); }";
    page += "        else if (document.msExitFullscreen) { document.msExitFullscreen(); }";
    page += "    }";
    page += "}";
    page += "fullscreenBtn.onclick = toggleFullscreen;";
    page += "function updateFullscreenBtn() {";
    page += "    if (document.fullscreenElement || document.webkitFullscreenElement || document.msFullscreenElement) {";
    page += "        fullscreenBtn.textContent = '退出全屏';";
    page += "    } else {";
    page += "        fullscreenBtn.textContent = '全屏';";
    page += "    }";
    page += "}";
